        ...
        if ($obj->getVar('field_show') || $obj->getVar('field_edit')) {
            ...
            if (is_object($profile_module)) {
                ...
                if ($obj->getVar('field_show')) {
                    $groupperm_handler->addRight('profile_show', $obj->getVar('field_id'), XOOPS_GROUP_USERS, $profile_module->getVar('mid'));
                }
                if ($obj->getVar('field_edit')) {
                    $groupperm_handler->addRight('profile_edit', $obj->getVar('field_id'), XOOPS_GROUP_USERS, $profile_module->getVar('mid'));
                }
